...
public class FormMahasiswa extends javax.swing.JFrame {
    ...
    private void btTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btTambahActionPerformed
        ...
        if (!nim.isEmpty() && !nama.isEmpty() && !prodi.isEmpty() && !ipk.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Field tidak boleh kosong!", "Informasi", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if (mahasiswa != null) {
            if (JOptionPane.showConfirmDialog(this, "Apakah data mahasiswa akan dihapus?", "Konfirmasi", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == 0) {
                modelMahasiswa.delete(mahasiswa, modelMahasiswa.getRowCount() - 1);
                JOptionPane.showMessageDialog(this, "Data berhasil dihapus", "Informasi", JOptionPane.INFORMATION_MESSAGE);
                clear();
            }
        } else {
            JOptionPane.showMessageDialog(this, "Pilih data terlebih dahulu", "Informasi", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void btUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btUpdateActionPerformed
        if (mahasiswa != null) {
            ...
            if (!nim.isEmpty() && !nama.isEmpty() && !prodi.isEmpty() && !ipk.isEmpty()) {
                Mahasiswa m = new Mahasiswa(nim, nama, Float.parseFloat(ipk), prodi);
                modelMahasiswa.update(m, tblMahasiswa.getSelectedRow());
    ...
    private void clear() {
        ...
        txtProdi.setText("");
        txtIPK.setText("");
        tblMahasiswa.getSelectionModel().clearSelection();
        mahasiswa = null;
    }
